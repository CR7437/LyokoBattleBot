...
public enum  MONSTERS {
    ...
    Tarantula(Arrays.asList(MATTACKS.TACKLE,MATTACKS.TOSS,MATTACKS.tLASER,MATTACKS.tCHARGE,MATACKS.tSLAM)),
    Megatank(Arrays.asList(MATTACKS.TACKLE,MATTACKS.mLASER,,MATACKS.mROLL)),
